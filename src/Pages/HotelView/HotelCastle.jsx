...
function HotelCastle() {
  return (
    <section className='mt-20 mb-16'>
        <div className="container px-4 md:px-8 lg:px-10 mx-auto w-[100%]">
            {/* Hotel-Castle-left-side  */}
            <div className='flex items-center justify-between md:w-[60%] w-full'>
                <div>
            ...
            <div className='flex items-center py-3 mt-8 border-t-2 border-b-2 lg:gap-24 md:w-[60%] w-full gap-10'>
                    <div>

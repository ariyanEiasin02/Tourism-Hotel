...
function WriteReview(props) {
  return (
    <section className='container w-full px-4 md:px-8'>
 ...
 <div className='w-full'>
    ...
    <button className='bg-[#8B3EEA] px-10 py-3 text-white font-semibold rounded-md hover:bg-[#2B2540] hover:translate-y-3 transition-all duration-700 ease-linear mx-auto mt-5 block mb-10'>{props.btnText}</button>
   </div>
   </div>

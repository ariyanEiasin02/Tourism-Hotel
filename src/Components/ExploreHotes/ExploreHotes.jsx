                    ...
                    <Tabs>
                        <TabList>
                            <div className="mt-8 flex justify-center gap-6 flex-wrap mb-6">
                                ...
                                <Tab className="border-2 py-3 px-5 border-[#199E9D] cursor-pointer rounded-lg font-open-sans text-base md:text-[18px] outline-none">Hotels</Tab>
                                <Tab className="border-2 py-3 px-5 border-[#199E9D] cursor-pointer rounded-lg font-open-sans text-base md:text-[18px] outline-none">Tours</Tab>
                                <Tab className="border-2 py-3 px-5 border-[#199E9D] cursor-pointer rounded-lg font-open-sans text-base md:text-[18px] outline-none">Space</Tab>
                                <Tab className="border-2 py-3 px-5 border-[#199E9D] cursor-pointer rounded-lg font-open-sans text-base md:text-[18px] outline-none">Events</Tab>
                            </div>
                        </TabList>
                                    ...
                                    exploreItems.map((explore) => (
                                        <div class="group bg-white rounded-lg shadow-lg overflow-hidden">
                                            <div className="relative overflow-hidden">
                                                <img src={explore.exploreImages} alt="Hotel" class="w-full h-full object-cover group-hover:scale-125 duration-500" />
                                                <div class="absolute bottom-3 left-2 flex items-center text-white text-[18px]">
                                                    <div className="">
                                                        <MdLocationPin />
                                                    </div>
                                                    <div className="ml-1">
                                                        <p className='font-playfair font-semibold'>{explore.exploreLocation}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="p-4">
                                                <h2 class="font-playfair text-[18px] font-semibold text-[#333]">{explore.exploreTitle}</h2>

                                                <div class="flex items-center mt-1 text-yellow-500">
                                                    <span class="font-open-sans font-bold text-sm">{explore.exploreReview}</span>
                                                    <span class="text-gray-500 text-sm ml-3">(1214 reviews)</span>
                                                </div>

                                                <div class="mt-2">
                                                    <span class="font-playfair text-xl font-semibold text-[#199E9D]">${explore.explorePrice}</span>
                                                    <span class="font-open-sans font-semibold text-[#333] text-sm ml-2">{explore.exploreStar}</span>
                                                </div>
                                            </div>
                                        </div>
